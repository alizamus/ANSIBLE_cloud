...
def main(argv):
	...
	command = "/root/code/cloud-config/config" + " " + "--username user" + username + " --password user" + username + " --tenant sandbox"+ username + " --api-server 127.0.0.1 " + "add floating-ip-pool public-user" + username + "-net-pool --network public-user" + username + "-net" 
	#print command	
	os.system(command)
