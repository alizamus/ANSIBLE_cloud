...
def main(argv):
	...
	command = "/root/code/cloud-config/config" + " " + "--username user" + username + " --password user" + username + " --tenant sandbox"+ username + " --api-server 127.0.0.1 " + "add network public-user" + username + "-net " + "--ipam ipam-default --subnet " + subnet + " --route-target " + target
